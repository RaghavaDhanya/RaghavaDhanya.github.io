"""Render eigenvectors_animation.html to a GIF.

Usage:
    uv run render_eigenvectors.py

Output:
    ../../../static/images/intuitive-understanding-of-pca/eigenvectors.gif
"""
...
HTML_FILE = HERE / "eigenvectors_animation.html"
OUT_GIF = (
