"""Render projection_animation.html to a GIF.

Usage:
    uv run render_projection.py

Output:
    ../../../static/images/intuitive-understanding-of-pca/projection.gif
"""
...
HTML_FILE = HERE / "projection_animation.html"
OUT_GIF = (
