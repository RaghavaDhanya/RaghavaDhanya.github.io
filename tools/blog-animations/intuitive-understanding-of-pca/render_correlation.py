"""Render correlation_animation.html to a GIF using Playwright + imageio.

Usage:
    uv run render.py

Output:
    ../../../static/images/intuitive-understanding-of-pca/correlation_morph.gif
"""
...
HTML_FILE = HERE / "correlation_animation.html"
OUT_GIF = (
    HERE.parent.parent.parent
    / "static"
    / "images"
    / "intuitive-understanding-of-pca"
    / "correlation_morph.gif"
)

# Must match the phase durations declared in correlation_animation.html
