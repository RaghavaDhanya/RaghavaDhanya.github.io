"""Render scaling_matrix_animation.html to a GIF using Playwright + imageio.

Usage:
    uv run render_scaling_matrix.py

Output:
    ../../../static/images/intuitive-understanding-of-pca/scaling_matrix.gif
"""
...
HTML_FILE = HERE / "scaling_matrix_animation.html"
OUT_GIF = (
...
# Must match the phase durations declared in the HTML
PHASE_DURATIONS_MS = [600, 1000, 300, 1000, 400, 1000, 300, 1000, 400, 1000, 300, 1000, 600]
