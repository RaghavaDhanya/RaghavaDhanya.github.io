"""Render covariance_transform_animation.html to a GIF using Playwright + imageio.

Usage:
    uv run render_covariance_transform.py

Output:
    ../../../static/images/intuitive-understanding-of-pca/covariance_transform.gif
"""
...
HTML_FILE = HERE / "covariance_transform_animation.html"
OUT_GIF = (
    HERE.parent.parent.parent
    / "static"
    / "images"
    / "intuitive-understanding-of-pca"
    / "covariance_transform.gif"
)
